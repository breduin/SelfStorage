...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('PREORDER', 'Preorder'), ('ORDER', 'Order'), ('DONE', 'Done')], default='PREORDER', max_length=10, verbose_name='Статус заказа')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.IntegerField(help_text='Введите номер телефона, например, +79999999999', verbose_name='Телефонный номер склада')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(limit_choices_to={'id': 1}, on_delete=django.db.models.deletion.CASCADE, related_name='price', to='storage.category', verbose_name='Категория')),
